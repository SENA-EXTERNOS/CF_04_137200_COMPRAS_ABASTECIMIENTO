  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        ...
        p.mb-4 #[b Objetivo] El cuestionario del presente módulo tendrá como objetivo que el aprendiz finalice el proceso de apropiación de los conocimientos adquiridos. 
